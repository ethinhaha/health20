...
public class Ongoing_subject extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String url="http://medhint.nhri.org.tw/hpforum/test3.jsp?seq_id="+seq_id;
		...
		ListAdapter adapter=new SimpleAdapter(this,data,R.layout.listview_subject,new String[] {"title", "author", "date"},
		...
		subject_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> adapterView, View view,
				...
				Map<String, Object> map =(Map<String, Object>) adapter.getItem(position);
				 ...
				 intent.setClass(Ongoing_subject.this, SubjectDetail.class);
