...
public class FileImageUpload {  
     ...
     * @return 返回响应的内容  
     */   
     public static String uploadFile(File file,String RequestURL,String seq_id) {   
         ...
         try {  
             ...
             if(file!=null) {   
                 ...
                 */   
                 sb.append("Content-Disposition: form-data; name=\"img\"; seq_id=\""+seq_id+"\"ori_filename=\""+file.getName()+"\""+LINE_END);  
