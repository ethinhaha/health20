...
public class LoginSuccess extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Toast.makeText(this, "3."+json+":"+user_mail+":"+user_pw, Toast.LENGTH_LONG).show();
		while(json==null){
			String url="http://medhint.nhri.org.tw/hpforum/test.jsp?email="+user_mail+"&pw="+user_pw;
		...
		ongoing.setOnClickListener(new View.OnClickListener(){
			public void onClick(View v) 
			 {
				 GetMessage message = new GetMessage();
				 String msg = message.stringQuery("http://medhint.nhri.org.tw/hpforum/test2.jsp?user_seqid="+user_seqid.getText().toString()+"&discussion=ongoing");
				 //Toast pop=Toast.makeText(LoginSuccess.this,msg,Toast.LENGTH_LONG);
				 //pop.show();
			...
			public void onClick(View v) 
			 {
				 GetMessage message = new GetMessage();
				 String msg = message.stringQuery("http://medhint.nhri.org.tw/hpforum/test2.jsp?user_seqid="+user_seqid.getText().toString()+"&discussion=previous");
				 //Toast pop=Toast.makeText(LoginSuccess.this,msg,Toast.LENGTH_LONG);
				 //pop.show();
